...
public struct Sorts {
    ...
    /**
        ...
        size N.
    */
    public static func selectionSort<T>(array arr: [T], startingAt startIndex: Int = 0, endingAt endIndex: Int = arr.count - 1, order: Order) -> [T] where T: Comparable {
...
let arr = [1,2,3,1,2]
let _ = Sorts.selectionSort(array: arr, order: .ascending)
